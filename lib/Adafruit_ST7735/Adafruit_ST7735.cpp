...
*/
Adafruit_ST7735::Adafruit_ST7735(SPI::SPI *spi, int8_t cs, int8_t dc,
                                 int8_t rst)
    : Adafruit_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, spi, cs,
                      dc, rst) {}
...
{
  commonInit(Rcmd1, sizeof(Rcmd1));
  if (options == INITR_GREENTAB)
  {
    displayInit(Rcmd2green, sizeof(Rcmd2green));
    _colstart = 2;
    _rowstart = 1;
  }
  else if ((options == INITR_144GREENTAB) || (options == INITR_HALLOWING))
  {
    ...
    displayInit(Rcmd2green144, sizeof(Rcmd2green144));
    _colstart = 2;
  ...
  else if (options == INITR_MINI160x80)
  {
    ...
    displayInit(Rcmd2green160x80, sizeof(Rcmd2green160x80));
    _colstart = 24;
    _rowstart = 0;
  }
  else
  {
    ...
    displayInit(Rcmd2red, sizeof(Rcmd2red));
  }
  displayInit(Rcmd3, sizeof(Rcmd3));
