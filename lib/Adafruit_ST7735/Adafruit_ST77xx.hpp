...
{
public:
  Adafruit_ST77xx(uint16_t w, uint16_t h, SPI::SPI *spi, int8_t CS,
...
protected:
  uint8_t _colstart = 0,             ///< Some displays need this changed to offset
      ...
      spiMode = SPI::SPIMode::MODE0; ///< Certain display needs MODE3 instead

  void begin(uint32_t freq = 0);
  void commonInit(const uint8_t *cmdList, const uint8_t size);
  void displayInit(const uint8_t *addr, const uint8_t size);
