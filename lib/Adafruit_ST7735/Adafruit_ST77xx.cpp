...
*/
/**************************************************************************/
Adafruit_ST77xx::Adafruit_ST77xx(uint16_t w, uint16_t h, SPI::SPI *spi,
                                 GPIO::GPIO cs, GPIO::GPIO dc, GPIO::GPIO rst)
...
*/
/**************************************************************************/
void Adafruit_ST77xx::displayInit(const uint8_t *addr, const uint8_t size)
{
  ...
  numCommands = size; // Number of commands to follow
  while (numCommands--)
  {                                  // For each command...
...
*/
/**************************************************************************/
void Adafruit_ST77xx::commonInit(const uint8_t *cmdList, const uint8_t size)
{
  begin();

  if (cmdList)
  {
    displayInit(cmdList, size);
  }
}
