...
public:
  ...
  Adafruit_SPITFT(uint16_t w, uint16_t h, SPI::SPI *spi, GPIO::GPIO cs,
                  GPIO::GPIO dc, GPIO::GPIO rst); // TODO NULL
  ...
  */
  ...
  void initSPI(uint32_t freq = 0, uint8_t spiMode = SPI::SPIMode::MODE0);
...
protected:
  ...
  union
  {
    ...
    {                 //   Values specific to HARDWARE SPI:
      SPI::SPI *_spi; ///< SPI class pointer
      SPI::SPISettings settings; ///< SPI transaction settings
    ...
    { //   Values specific to SOFTWARE SPI:
      ...
      GPIO::GPIO _mosi;              ///< MOSI pin #
      GPIO::GPIO _miso;              ///< MISO pin #
      GPIO::GPIO _sck;               ///< SCK pin #
...
#endif                         // end HAS_PORT_SET_CLR
#endif                         // end USE_FAST_PINIO
      GPIO::GPIO _d0;              ///< Data pin 0 #
      GPIO::GPIO _wr;              ///< Write strobe pin #
      GPIO::GPIO _rd;              ///< Read strobe pin # (or -1)
  ...
  GPIO::GPIO _rst;         ///< Reset pin # (or -1)
  GPIO::GPIO _cs;          ///< Chip select pin # (or -1)
  GPIO::GPIO _dc;          ///< Data/command pin #
